...
const
  ...
  { Encoder names }
  MPEG_ENCODER: array [0..7] of AnsiString =
...
type
  ...
  VBRData = record
    ...
    VendorID: AnsiString;                                { Vendor ID (if present) }
  end;
...
function FindVendorID(const Data: array of Byte; Size: Word): AnsiString;
var
  Iterator: Integer;
  VendorID: AnsiString;
begin
